...
# print(np.exp(df_log))
# print(ppredict)
title1 = 'Pier 1 - Embarking - Forecast'
title2 = 'Pier 3 - Embarking - Forecast'
title3 = 'Pier 1 - Disembarking - Forecast'
title4 = 'Pier 3 - Disembarking - Forecast'
title5 = 'Pier 1 - Shipcall - Forecast'
title6 = 'Pier 3 - Shipcall - Forecast'
